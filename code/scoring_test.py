...
class TestScoringFunctions(unittest.TestCase):
    def test_get_data_stats(self):
        ...
        self.assertTrue(1 <= response_time_mean <= 3600)
    ...
    def test_calculate_final_score(self):
        ...
        self.assertEqual(len(all_scores), 100)
        ...
        data = [factory.gen_fake_patient() for x in range(5)]
        accepted_mean, accepted_std, canceled_mean, canceled_std, response_time_mean, response_time_std = scoring.get_data_stats(
            data
        )
        scored_data = scoring.calculate_intrinsic_score(
        ...
        # test handling small patient list
        res = scoring.final_score(location, scored_data)
        # ensure length is 5
