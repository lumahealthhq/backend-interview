...
exports.findPatientDataRanges = (
  ...
  patients.forEach((patient) => {
    for (let category in SCORE_COMPOSITION) {
      ...
      // calculating category bottom threshold, which defaults to the bottom ten percent
...
exports.sortPatients = (
  ...
  // checking if we can fill the 10% of the list with littleBehaviorDataPatients
  if (
