...
describe('Normalization Tests', () => {
    ...
    it('should return a normalized age between 0 and 1', () => {
        expect(normalizeAge(50)).toBe(0.05);
    });

    it('should return a normalized age of 0.1 for values over 100', () => {
        expect(normalizeAge(150)).toBe(0.1);
    });

    it('should return a normalized distance between 0 and 1', () => {
        expect(normalizeDistance(10000, 20000)).toBe(0.05);
    });

    it('should return a normalized distance of 0.1 for values over 20000', () => {
        expect(normalizeDistance(25000, 20000)).toBe(0.1);
    });

    it('should return a normalized value for accepted offers between 0 and 1', () => {
        expect(normalizeAcceptedOffers(50)).toBe(0.15);
    });

    it('should return a normalized value for cancelled offers between 0 and 1', () => {
        expect(normalizeCancelledOffers(50)).toBe(0.15);
    });

    it('should return a normalized value for reply time between 0 and 1', () => {
